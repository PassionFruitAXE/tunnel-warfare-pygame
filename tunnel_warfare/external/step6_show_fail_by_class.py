...
from pythonProject.actor.fail_sprite import FailSprite
...
def lode_actor_image():
    ...
    for i in range(1,10):#取值1~9
        image_path = "../resources/images/fail/f_"+str(i)+".png"
        print(image_path)
        image = pygame.image.load(image_path)
        actor_images.append(image)
    return  actor_images

def step6_show_fail_by_class():
    """
    step6:显示失败后的图片
    :return:
    """
